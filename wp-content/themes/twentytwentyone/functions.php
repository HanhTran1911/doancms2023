...
function twenty_twenty_one_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar_Left', 'twentytwentyone' ),
			'id'            => 'sidebar-left',
			'description'   => esc_html__( 'Add widgets here to appear in your sidebar left.', 'twentytwentyone' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s sidebar-left">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
		)
...
function twenty_twenty_one_widgets_init_sidebarright() {

	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar_right', 'twentytwentyone' ),
			'id'            => 'sidebar-right',
			'description'   => esc_html__( 'Add widgets here to appear in your footer.', 'twentytwentyone' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
...
add_action( 'widgets_init', 'twenty_twenty_one_widgets_init_sidebarright' );
